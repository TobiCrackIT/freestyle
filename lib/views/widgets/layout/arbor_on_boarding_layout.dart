...
class ArborOnBoardingLayout extends StatefulWidget {
  ...
  @override
  ArborOnBoardingLayoutState createState() => ArborOnBoardingLayoutState();
}

class ArborOnBoardingLayoutState extends State<ArborOnBoardingLayout> {
  ...
  void initState() {
    super.initState();
    var initialPage = min(widget.initialPage, getPagesLength() - 1);
  ...
  Widget build(BuildContext context) {
    ...
    var isSkipBtn = (!_isSkipPressed && !isLastPage && widget.showSkipButton);
